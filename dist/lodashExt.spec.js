define(["require", "exports", 'lodashExt'], function (require, exports) {
    describe('lodash extensions', function () {
        ...
        it('renameField', function () {
            ...
            expect(_.renameFields('not object', {})).toBe('not object');
        });
        ...
        it('getCharFromKeypress method', function () {
            // IE
            expect(_.getCharFromKeypress({ which: null, keyCode: 70 })).toBe('F');
            expect(_.getCharFromKeypress({ which: null, keyCode: 10 })).toBe(null);
            // browsers
            expect(_.getCharFromKeypress({ which: 70, charCode: 70 })).toBe('F');
            expect(_.getCharFromKeypress({ which: 10, charCode: 10 })).toBe(null);
            expect(_.getCharFromKeypress({ which: 70, charCode: 0 })).toBe(null);
        });
